...
- [ ] Automated basket composition / direct export to supermarket accounts
- [ ] Supermarket credential storage & automated login handling
...
- [x] Confidence Level Flag ("80% likely (Aggregator match)")
